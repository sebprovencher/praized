<?php
	function smarty_function_mtpraizedmerchantspagination($args, &$ctx) {
		$pagination = $ctx->stash("collections_praized_pagination");
		...
		if( ! is_null($pagination) && intval($pagination->page_count) > 1) {
			...
			if($current_page == 1)
				...
				$str .= "<li><a href=\"" . $url . "?q=" . $_GET["q"] . "&l=" . $_GET["l"] . "&page=" . ($current_page - 1) . "\">" . $previous_label . "</a></li>";
			...
			foreach($visible as $item) {
				...
				if($current_page == $item) 
					...
					$str .= "<li><a href=\"" . $url . "?q=" . $_GET["q"] . "&l=" . $_GET["l"] . "&page=" . $item . "\">" . $item . "</a></li>";	
			...
			if($current_page == $total_pages)
				...
				$str .= "<li><a href=\"" . $url . "?q=" . $_GET["q"] . "&l=" . $_GET["l"] . "&page=" . ($current_page + 1) . "\">" . $next_label . "</a></li>";
