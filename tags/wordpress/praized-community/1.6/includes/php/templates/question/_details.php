...
<div class="praized-question-details">
  <?php if ( pzdc_has_question() ) : ?>
  	<h2 class="praized-question-header"><?php pzdc_e('Answer'); ?> <?php printf(pzdc__('<a href="%s">%s</a>\'s'), pzdc_user_permalink('', FALSE), pzdc_user_login(FALSE)); ?> <?php pzdc_e('question'); ?></h2>
