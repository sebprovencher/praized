...
<div class="praized-answer-details">
	<?php if ( pzdc_has_answer() ) : ?>
	  ...
	  <h2 class="praized-question-header"><?php printf(pzdc__('<a href="%s">%s</a>\'s'), pzdc_user_permalink('', FALSE), pzdc_user_login(FALSE)); ?> <?php pzdc_e('answer'); ?></h2>
	  ...
	  <?php if ( pzdc_has_question() ) : /* VERY IMPORTANT TO RESET THE VALUE OF $PraizedCommunity->tpt_user */ ?>
		<div style="margin-bottom: 30px;">
			...
			<div>
				<a href="<?php pzdc_user_permalink(); ?>"><?php pzdc_user_login(); ?></a> <a href="<?php pzdc_question_permalink(); ?>"><?php pzdc_e('asked')?></a> <?php pzdc_time_distance(pzdc_question_created_at(FALSE)); ?>:
	  ...
	  <?php if ( pzdc_has_answer() ) : /* VERY IMPORTANT TO RESET THE VALUE OF $PraizedCommunity->tpt_user */ ?>
	    ...
	    <div class="praized-action-item" style="margin-top: 20px;">
		  <a href="<?php pzdc_user_permalink(); ?>"><img src="<?php pzdc_user_avatar_small(); ?>" width="40" height="40" border="0" style="float:left; margin-right: 10px;"/></a>
	      <a href="<?php pzdc_user_permalink(); ?>"><?php pzdc_user_login(); ?></a> <?php printf(pzdc__('gave an <a href="%s">%s</a>'), pzdc_answer_permalink(FALSE), pzdc__('answer')); ?> <?php pzdc_time_distance(pzdc_answer_created_at(FALSE)); ?>:
